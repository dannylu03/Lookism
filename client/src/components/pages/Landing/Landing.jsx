    ...
    return (
        <div className='relative flex flex-col min-h-screen items-center bg-cultured'>
            ...
            <div className='flex flex-col items-center'>
                <img src={landing_image} alt="card images of styles" className='scale-75'/>
                <h3 className='text-2xl text-cafe-noir'>Find Your Lookism. Discover Yourself.</h3>
                <div className='flex flex-col justify-around w-1/2'>
                    ...
                    <button className="w-full inline-block px-6 py-2.5 bg-camel text-white font-medium text-xs leading-normal uppercase rounded shadow-md hover:shadow-lg transition duration-150 ease-in-out mt-3" onClick={() => {setOpenLoginModal(true)}}>
                        Login
                    </button>
                </div>
            </div>
